...
const ProductDetails = ({ route: { params } }) => {
  ...
  const name = "Play Station 5 (Gold Edition)";
  const price = "$599";
  const stock = 5;
  const description =
    "The PlayStation 5 (PS5) is a cutting-edge gaming console from Sony. It features powerful hardware, including a custom CPU and GPU, enabling stunning graphics and fast load times. The console offers an immersive gaming experience with a vast library of games, 4K visuals, and support for ray tracing and fast SSD storage.";
  ...
  return (
    <View
      ...
      <View
        ...
        <Text numberOfLines={2} style={{ fontSize: 22 }}>
          {name}
        </Text>
        ...
        <View
          ...
          <Text
            style={{ color: colors.color3, fontSize: 15, fontWeight: "200" }}>
            Quantity
          </Text>
          <View
            style={{
